            ...
            {favorites.length === 0 ? (
              ...
              >
                ...
                <p className="text-muted-foreground mb-8 max-w-md mx-auto">
                  Start exploring recipes and save your favorites to keep track of dishes you love!
                </p>
                <Link
              ...
              <>
                ...
                >
                  <p className="text-muted-foreground">
                    Showing <span className="font-bold text-foreground">{favorites.length}</span> favorite
                    {favorites.length !== 1 ? 's' : ''}
                  </p>
                </motion.div>

                {/* Favorites Grid */}
                <RecipeGrid meals={favorites} isLoading={false} />
